...
torchrun --nproc_per_node=4 train_onlywarp.py \
    --train_dataset "10_000 @ Habitat(800_000, split='train', ROOT='/cis/home/cpeng/dust3r/data/habitat_processed', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=16, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ BlendedMVS(split='train', ROOT='/cis/home/cpeng/dust3r/data/blendedmvs_processed', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=16, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ MegaDepth(split='train', ROOT='/cis/home/cpeng/dust3r/data/megadepth_dataset_processed', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=16, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ ARKitScenes(split='train', ROOT='/cis/home/cpeng/dust3r/data/arkitscenes_processed', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=256, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ Co3d(split='train',mask_bg='rand',ROOT='/cis/home/cpeng/dust3r/data/co3d_subset_processed',resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=256, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ StaticThings3D(ROOT='/cis/home/cpeng/dust3r/data/static_3d_dataset_processed', mask_bg='rand', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=256, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ ScanNetpp(split='train', ROOT='/cis/home/cpeng/dust3r/data/scannetpp_processed', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=256, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 10_000 @ WildRGBD(split='train', ROOT='/cis/home/cpeng/dust3r/data/wildrgb_processed', mask_bg='rand',resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], aug_crop=16, aug_monocular=0.005, transform=ColorJitter, n_corres=8192, nneg=0.5) + 20_000 @ MegaDepth_all(split='train', ROOT='/home/cpeng26/scratchrchella4/data/megadepth', min_overlap=0.01, aug_crop=16, resolution=224, transform=ColorJitter) + 20_000 @ MegaDepth_all(split='train', ROOT='/cis/net/io104/data/zshao14/megadepth', min_overlap=0.35, aug_crop=16, resolution=224, transform=ColorJitter)" \
    --test_dataset "1_000 @ BlendedMVS(split='val', ROOT='/cis/home/cpeng/dust3r/data/blendedmvs_processed', resolution=(512,384), seed=777, n_corres=1024) + 1_000 @ MegaDepth(split='val',  ROOT='/cis/home/cpeng/dust3r/data/megadepth_dataset_processed', resolution=(512,336), seed=777, n_corres=1024) + 1_000 @ Co3d(split='test', mask_bg='rand', ROOT='/cis/home/cpeng/dust3r/data/co3d_subset_processed', resolution=(512,384), seed=777, n_corres=1024)" \
    ...
    --lr 0.0001 --min_lr 1e-06 --warmup_epochs 8 --epochs 50 --batch_size 8 --accum_iter 2 \
    --save_freq 1 --keep_freq 2 --eval_freq 1 --print_freq=10 --disable_cudnn_benchmark \
