...
from dust3r.datasets.utils.transforms import ImgNorm, DepthNorm
...
class BaseStereoViewDataset2 (EasyDataset):
    """ Define all basic options.
    ...
    def __getitem__(self, idx):
        ...
        data_dict = {
            'im_A': view1['img'],
            'im_B': view2['img'],
            'im_A_depth': view1['depthmap'],
            'im_B_depth': view2['depthmap'],
            ...
            'pts1': view1['pts3d'],
            'pts2': view2['pts3d'],
            'mask1': view1['valid_mask'],
            'mask2': view2['valid_mask'],
            'im_A_identifier': view1['instance'],
            'im_B_identifier': view2['instance'],
            'im_A_path': view1['label'],
            'im_B_path': view2['label'],
        }
        return data_dict
