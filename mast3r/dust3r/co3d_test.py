...
if __name__ == "__main__":
    ...
    dataset = Co3d(split='train', ROOT="/export/r24a/data/zshao/data/co3d_subset_processed", resolution=224, aug_crop=16)
    dataset.scenes
    #dataset = Co3d(split='train', ROOT='/export/r24a/data/zshao/data/co3d_subset_processed', aug_crop='auto', mask_bg='rand', resolution=[(512, 384), (512, 336), (512, 288), (512, 256), (512, 160)], transform=ColorJitter)
