...
def get_model(pretrained_backbone=True, resolution = "medium", **kwargs):
    ...
    proj16 = nn.Sequential(nn.Conv2d(1024+768, 1024, 1, 1), nn.BatchNorm2d(1024), nn.ReLU(inplace=True), nn.Conv2d(1024, 512, 1, 1), nn.BatchNorm2d(512),nn.ReLU(inplace=True))
    ...
    matcher = RegressionMatcher_mast3r_dpt(encoder, decoder, h=h, w=w,**kwargs)
