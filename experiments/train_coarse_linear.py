...
def get_model(pretrained_backbone = True, model_name = 'resnet50', resolution = "low", t = 0, alpha = 0.5,**kwargs):
    ...
    print(h, w)
    matcher = knn_matcher(encoder, h, w)
    return matcher
...
def train(args):
    ...
    N = (16 * 250000)  # 250k steps of batch size 32
    # checkpoint every
    k = 25000 // romatch.STEP_SIZE

    # Data "/export/r33/data/r24_data/megadepth"
    mega = MegadepthBuilder(data_root="/cis/net/r24a/data/zshao/data/megadepth", loftr_ignore=True, imc21_ignore = True)
