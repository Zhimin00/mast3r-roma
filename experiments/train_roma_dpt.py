...
from romatch.benchmarks import MegaDepthPoseEstimationBenchmark, MegadepthDenseBenchmark_depth, MegadepthDenseBenchmark, HpatchesHomogBenchmark
...
def train(args):
    ...
    dataset_path = '/cis/net/io104/data/zshao14/data/megadepth'
    # Data
    ...
    parameters = [
        ...
        {"params": [p for n, p in model.decoder.named_parameters() if not n.startswith("dpt_refiner")], "lr": romatch.STEP_SIZE * 1e-4 / 8},
        {'params': model.decoder.dpt_refiner1.parameters(), "lr": romatch.STEP_SIZE * 1e-5 / 8},
        {'params': model.decoder.dpt_refiner2.parameters(), "lr": romatch.STEP_SIZE * 1e-5 / 8}
    ]
