...
def get_model(pretrained_backbone=True, resolution = "medium", **kwargs):
    ...
    proj16 = nn.Sequential(nn.Conv2d(1024+768+1024, 1024, 1, 1), nn.BatchNorm2d(1024))
...
def train(args):
    ...
    mega1500_benchmark = MegaDepthPoseEstimationBenchmark(dataset_path+'/megadepth_test_1500')
